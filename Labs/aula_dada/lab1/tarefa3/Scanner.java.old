...
public class Scanner {
	...
	static {
		...
		for (int i = 66; i <= 69; ++i) start.set(i, 3);
		for (int i = 71; i <= 77; ++i) start.set(i, 3);
		for (int i = 81; i <= 82; ++i) start.set(i, 3);
		for (int i = 84; i <= 90; ++i) start.set(i, 3);
		start.set(83, 16); 
		start.set(10, 5); 
		start.set(80, 17); 
		start.set(70, 18); 
		...
		literals.put("falecido", new Integer(13));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 3:
					...
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 3; break;}
				...
				case 16:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'o') {AddCh(); state = 22; break;}
					else {t.kind = 3; break loop;}
				case 17:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'b' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'a') {AddCh(); state = 23; break;}
					else {t.kind = 3; break loop;}
				case 18:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'i') {AddCh(); state = 24; break;}
					else {t.kind = 3; break loop;}
				case 19:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'u' || ch >= 'w' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'v') {AddCh(); state = 25; break;}
					else {t.kind = 3; break loop;}
				case 20:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'e') {AddCh(); state = 26; break;}
					else {t.kind = 3; break loop;}
				case 21:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 't' || ch >= 'v' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'u') {AddCh(); state = 27; break;}
					else {t.kind = 3; break loop;}
				case 22:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch == 'a' || ch >= 'c' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'b') {AddCh(); state = 28; break;}
					else {t.kind = 3; break loop;}
				case 23:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'i') {AddCh(); state = 29; break;}
					else {t.kind = 3; break loop;}
				case 24:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'k' || ch >= 'm' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'l') {AddCh(); state = 30; break;}
					else {t.kind = 3; break loop;}
				case 25:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'o') {AddCh(); state = 31; break;}
					else {t.kind = 3; break loop;}
				case 26:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 't') {AddCh(); state = 32; break;}
					else {t.kind = 3; break loop;}
				case 27:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 't') {AddCh(); state = 33; break;}
					else {t.kind = 3; break loop;}
				case 28:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'r') {AddCh(); state = 34; break;}
					else {t.kind = 3; break loop;}
				case 29:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 's') {AddCh(); state = 35; break;}
					else {t.kind = 3; break loop;}
				case 30:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'g' || ch >= 'i' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'h') {AddCh(); state = 36; break;}
					else {t.kind = 3; break loop;}
				case 31:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 's') {AddCh(); state = 37; break;}
					else {t.kind = 3; break loop;}
				case 32:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 3; break;}
				...
				case 34:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'e') {AddCh(); state = 40; break;}
					else {t.kind = 3; break loop;}
				case 35:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 3; break;}
				...
				case 36:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'o') {AddCh(); state = 41; break;}
					else {t.kind = 3; break loop;}
				case 37:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 3; break;}
				...
				case 38:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 's') {AddCh(); state = 42; break;}
					else {t.kind = 3; break loop;}
				case 39:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'o') {AddCh(); state = 43; break;}
					else {t.kind = 3; break loop;}
				case 40:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'n') {AddCh(); state = 44; break;}
					else {t.kind = 3; break loop;}
				case 41:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 's') {AddCh(); state = 45; break;}
					else {t.kind = 3; break loop;}
				case 42:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 3; break;}
				...
				case 43:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 's') {AddCh(); state = 46; break;}
					else {t.kind = 3; break loop;}
				case 44:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 3; break;}
				...
				case 47:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'l' || ch >= 'n' && ch <= 'z') {AddCh(); state = 3; break;}
					else if (ch == 'm') {AddCh(); state = 48; break;}
					else {t.kind = 3; break loop;}
				case 48:
					recEnd = pos; recKind = 3;
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 3; break;}
