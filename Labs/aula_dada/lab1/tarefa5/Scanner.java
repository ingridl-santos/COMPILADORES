...
public class Scanner {
	...
	static {
		...
		for (int i = 49; i <= 57; ++i) start.set(i, 1);
		...
		literals.put("bool", new Integer(13));
		literals.put("if", new Integer(17));
		literals.put("elif", new Integer(18));
		literals.put("else", new Integer(19));
		literals.put("for", new Integer(20));
		literals.put("in", new Integer(21));
		literals.put("while", new Integer(23));
		literals.put("do", new Integer(24));
		literals.put("break", new Integer(25));
		literals.put("continue", new Integer(26));
		literals.put("read", new Integer(27));
		literals.put("write", new Integer(28));
		literals.put("true", new Integer(34));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					...
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'F' || ch >= 'a' && ch <= 'f') {AddCh(); state = 2; break;}
				...
				case 4:
					recEnd = pos; recKind = 1;
					if (ch == 'X' || ch == 'x') {AddCh(); state = 2; break;}
					else {t.kind = 1; break loop;}
				case 5:
					{t.kind = 5; break loop;}
				case 6:
