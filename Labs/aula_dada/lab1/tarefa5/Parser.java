...
public class Parser {
	...
	private static final boolean[][] set = {
		...
		{x,x,x,T, x,T,x,x, x,x,x,x, T,T,x,T, T,T,x,x, T,x,x,T, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,T, T,x,x}
