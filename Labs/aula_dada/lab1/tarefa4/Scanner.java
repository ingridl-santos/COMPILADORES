...
public class Scanner {
	...
	static final int maxT = 21;
	static final int noSym = 21;
	...
	static {
		...
		for (int i = 66; i <= 66; ++i) start.set(i, 1);
		for (int i = 69; i <= 69; ++i) start.set(i, 1);
		for (int i = 72; i <= 90; ++i) start.set(i, 1);
		for (int i = 97; i <= 122; ++i) start.set(i, 1);
		for (int i = 33; i <= 33; ++i) start.set(i, 2);
		...
		literals.put("C", new Integer(4));
		literals.put("Db", new Integer(6));
		literals.put("D", new Integer(7));
		literals.put("Eb", new Integer(9));
		literals.put("E", new Integer(10));
		literals.put("F", new Integer(11));
		literals.put("Gb", new Integer(13));
		literals.put("G", new Integer(14));
		literals.put("Ab", new Integer(16));
		literals.put("A", new Integer(17));
		literals.put("Bb", new Integer(19));
		literals.put("B", new Integer(20));
