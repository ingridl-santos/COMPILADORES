...
public class Parser {
	...
	void Texto() {
		Expect(2);
		Expect(1);
		html.addText(t.val.substring(1, t.val.length()-1)); 
	}
	...
	void EscolhaVarias() {
		String str = ""; ArrayList<String> opcoes; 
		Expect(4);
		Expect(1);
		str = t.val.substring(1, t.val.length()-1); 
		opcoes = ListaOpcoes();
	...
	ArrayList<String>  ListaOpcoes() {
		...
		Expect(5);
		Expect(1);
		opcoes.add(t.val.substring(1, t.val.length()-1)); 
		while (la.kind == 6) {
			Get();
			Expect(1);
			opcoes.add(t.val.substring(1, t.val.length()-1)); 
...
class Errors {
	...
	public void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 2: s = "\"TEXTO\" expected"; break;
			case 3: s = "\"ESCOLHAUMA\" expected"; break;
			case 4: s = "\"ESCOLHAVARIAS\" expected"; break;
			case 5: s = "\"(\" expected"; break;
			case 6: s = "\",\" expected"; break;
			case 7: s = "\")\" expected"; break;
			case 8: s = "??? expected"; break;
			case 9: s = "invalid Questao"; break;
