	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 1:
					if (ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); state = 1; break;}
				...
				case 4:
					if (ch == 'X') {AddCh(); state = 5; break;}
					else {state = 0; break;}
				case 5:
					if (ch == 'T') {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 6:
					if (ch == 'O') {AddCh(); state = 7; break;}
					else {state = 0; break;}
				case 7:
					{t.kind = 2; break loop;}
				case 8:
					if (ch == 'M') {AddCh(); state = 9; break;}
					else {state = 0; break;}
				case 9:
				...
				case 23:
					if (ch == 'L') {AddCh(); state = 24; break;}
					else {state = 0; break;}
				case 24:
					if (ch == 'H') {AddCh(); state = 25; break;}
					else {state = 0; break;}
				case 25:
					if (ch == 'A') {AddCh(); state = 26; break;}
					else {state = 0; break;}
				case 26:
					if (ch == 'U') {AddCh(); state = 8; break;}
					else if (ch == 'V') {AddCh(); state = 11; break;}
					else {state = 0; break;}
