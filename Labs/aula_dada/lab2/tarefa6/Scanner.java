...
public class Scanner {
	...
	static {
		...
		for (int i = 65; i <= 65; ++i) start.set(i, 2);
		for (int i = 69; i <= 69; ++i) start.set(i, 2);
		for (int i = 73; i <= 73; ++i) start.set(i, 2);
		for (int i = 79; i <= 79; ++i) start.set(i, 2);
		for (int i = 85; i <= 85; ++i) start.set(i, 2);
		for (int i = 66; i <= 68; ++i) start.set(i, 3);
		for (int i = 70; i <= 72; ++i) start.set(i, 3);
		for (int i = 74; i <= 78; ++i) start.set(i, 3);
		for (int i = 80; i <= 84; ++i) start.set(i, 3);
		for (int i = 86; i <= 90; ++i) start.set(i, 3);
		start.set(46, 4); 
