...
public class Scanner {
	...
	static {
		...
		literals.put("load", new Integer(5));
		literals.put("store", new Integer(6));
		literals.put("getstatic", new Integer(7));
		literals.put("putstatic", new Integer(8));
		literals.put("const", new Integer(9));
		literals.put("add", new Integer(10));
		literals.put("sub", new Integer(11));
		literals.put("mul", new Integer(12));
		literals.put("div", new Integer(13));
		literals.put("rem", new Integer(14));
		literals.put("neg", new Integer(15));
		literals.put("newarray", new Integer(16));
		literals.put("aload", new Integer(17));
		literals.put("astore", new Integer(18));
		literals.put("arraylength", new Integer(19));
		literals.put("pop", new Integer(20));
		literals.put("jmp", new Integer(21));
		literals.put("jeq", new Integer(22));
		literals.put("jne", new Integer(23));
		literals.put("jlt", new Integer(24));
		literals.put("jle", new Integer(25));
		literals.put("jgt", new Integer(26));
		literals.put("jge", new Integer(27));
		literals.put("call", new Integer(28));
		literals.put("return", new Integer(29));
		literals.put("enter", new Integer(30));
		literals.put("exit", new Integer(31));
		literals.put("scani", new Integer(32));
		literals.put("printi", new Integer(33));
		literals.put("prints", new Integer(34));
		literals.put("trap", new Integer(35));
